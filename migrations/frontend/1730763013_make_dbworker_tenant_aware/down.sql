CREATE POLICY isolation_policy_2 ON batch_spec_resolution_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON batch_spec_workspace_execution_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON changeset_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON cm_action_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON cm_trigger_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON context_detection_embedding_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON exhaustive_search_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON exhaustive_search_repo_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON exhaustive_search_repo_revision_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON explicit_permissions_bitbucket_projects_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON external_service_sync_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON gitserver_relocator_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON insights_query_runner_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON lsif_dependency_indexing_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON lsif_dependency_syncing_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON lsif_indexes USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON lsif_uploads USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON outbound_webhook_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON own_background_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON permission_sync_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON repo_context_stats_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON repo_embedding_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON repo_update_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON syntactic_scip_indexing_jobs USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
...
CREATE POLICY isolation_policy_2 ON changesets USING (tenant_id = (SELECT current_setting('app.current_tenant'::text)::integer AS current_tenant));
